...
| onPause                | A callback function that will be called when media is paused.                                 | `(e: NativeSyntheticEvent<{}>) => void`                                                                                                   | `None`  | ✅&nbsp;Android <br/> ✅&nbsp;iOS |
| onPlay                 | A callback function that will be called when media starts or resumes playing after pausing.   | `(e: NativeSyntheticEvent<{}>) => void`                                                                                                   | `None`  | ✅&nbsp;Android <br/> ✅&nbsp;iOS |
| onPlaybackStateChanged | A callback function that will be called when playback state changes.                          | `(e: NativeSyntheticEvent<{ state: GiphyPlaybackState }>) => void`                                                                        | `None`  | ✅&nbsp;Android <br/> ✅&nbsp;iOS |
