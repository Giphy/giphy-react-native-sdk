...
| resizeMode              | Determines how to resize the image when the frame doesn't match the raw image dimensions.       | [`ResizeMode`](https://github.com/Giphy/giphy-react-native-sdk/blob/6ff254aa680837dd52d66535d6b5a813930a7235/src/native/types.ts#L117-L122)   | `.Cover`      | ✅&nbsp;Android <br/> ✅&nbsp;iOS |
