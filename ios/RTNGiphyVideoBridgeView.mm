...
#import "RTNGiphyVideoBridgeView.h"
...
@interface RTNGiphyVideoBridgeView () <RCTRTNGiphyVideoViewViewProtocol>

@end

@implementation RTNGiphyVideoBridgeView {
  RTNGiphyVideoView * _view;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _view = [[RTNGiphyVideoView alloc] init];
...
{
  return RTNGiphyVideoBridgeView.class;
}
